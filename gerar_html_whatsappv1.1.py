...
def processar_anexos(texto):
    ...
    patterns = [
        ...
        r'([^\s‎/\\]+(?:\s+[^\s‎/\\]*)*\.(?:pdf|jpg|jpeg|png|mp4|mp3|doc|docx|xls|xlsx|wav|ogg|m4a|avi|mov|mkv|webm|gif|bmp|aac|ppt|pptx))\s*•',
        r'‎<anexado:\s*([^>]+)>',
        r'([^‎\s/\\]+\.(?:pdf|jpg|jpeg|png|mp4|mp3|doc|docx|xls|xlsx|wav|ogg|m4a|avi|mov|mkv|webm|gif|bmp|aac|ppt|pptx))(?!\s*•)'
    ]
